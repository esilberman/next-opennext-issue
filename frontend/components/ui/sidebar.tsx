...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      data-slot="sidebar-menu-subLabel"
      data-sidebar="menu-subLabel"
      className={cn(
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      data-slot="sidebar-menu-subLabel-item"
      data-sidebar="menu-subLabel-item"
      className={cn("group/menu-subLabel-item relative", className)}
      {...props}
    />
  )
}
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      data-slot="sidebar-menu-subLabel-button"
      data-sidebar="menu-subLabel-button"
      data-size={size}
      data-active={isActive}
      className={cn(
