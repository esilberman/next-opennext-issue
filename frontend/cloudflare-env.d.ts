/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 510ef4161a067b9aa963689021f9cc7d)
// Runtime types generated with workerd@1.20260312.1 2025-12-27 nodejs_compat
declare namespace Cloudflare {
	interface DevEnv {
		...
		NEXT_PUBLIC_CLOUDFLARE_ASSET_BASE_URL: string;
	}
	interface ProdEnv {
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "NEXT_PUBLIC_ENVIRONMENT" | "NEXT_PUBLIC_FRONTEND_URL" | "NEXT_PUBLIC_POSTHOG_HOST" | "NEXT_PUBLIC_POSTHOG_KEY" | "NEXT_PUBLIC_CONVEX_URL" | "NEXT_PUBLIC_CONVEX_SITE_URL" | "NEXT_PUBLIC_CLOUDFLARE_ASSET_BASE_URL">> {}
}
